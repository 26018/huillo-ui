<template>
    <component-submit-frame :data="data">
        <el-radio-group style="width: 100%" v-model="data.input">
            <el-radio style="width: 100%" v-for="(option,index) in JSON.parse(data.options)" :label="option">
                <read-only-text :data="option"/>
            </el-radio>
        </el-radio-group>
